        ...
        <div class="controls-section" :dark="$q.dark.isActive">
          <div class="section-card" :dark="$q.dark.isActive">
            ...
            <div class="controls-content">
              ...
              <!-- Quick Distances -->
              <div class="input-group">
                <label class="input-label" :style="$q.dark.isActive ? 'color:#e0e0e0' : ''">Szybkie dystanse</label>
                <div class="quick-distances">
                  <q-btn
                    v-for="dist in quickDistances"
                    :key="dist"
                    :outline="targetDistance !== dist"
                    :color="$q.dark.isActive ? (targetDistance === dist ? 'grey-7' : 'grey-5') : (targetDistance === dist ? 'primary' : 'grey-5')"
                    :text-color="isTacticalDarkMode ? 'red' : ''"
              ...
              <template v-slot:body-cell-offset="props">
                <q-td :props="props">
                  <q-chip
                    ...
                    :text-color="isTacticalDarkMode ? 'red' : 'white'"
                    size="sm"
