...
.modern-scope-types, .modern-collimator-types {
  background: #f0f4f8;
  border-radius: 8px;
  padding: 20px;
  color: #111;
}
.modern-scope-item, .modern-collimator-item {
  padding: 12px;
  background: #fff;
  border-radius: 6px;
...
@media (max-width: 768px) {
  ...
  .modern-features-section, .modern-scope-types, .modern-collimator-types {
    padding: 16px;
  }
  .modern-feature-item {
    padding: 6px 0;
