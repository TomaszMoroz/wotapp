  ...
  setup () {
    ...
    const content = {
      ...
      ch2_sub1: `
        ...
        <p><strong>146.</strong> W dniach wolnych od zajęć służbowych nie ogłasza się pobudki. Żołnierze mają obowiązek wstać w czasie ustalonym przez właściwego dowódcę jednostki (instytucji) wojskowej. Nie prowadzi się zorganizowanego porannego rozruchu fizycznego i apeli.</p>
